...
using UnityEngine.SceneManagement;
                                                                //for login into already existing account
public class Login : MonoBehaviour
{
   ...
   //public Button goToRegisterButton;
    ...
    public void Adminlogin(){ 
        ...
        credentials = new ArrayList(File.ReadAllLines(Application.dataPath + "/admin_credentials.txt"));
            ...
            if (isExists)
            {
                ...
                UserInfo.Username= usernameInput.text;              ////<<<<<<<//           <<<    storing info 
            loadWelcomeScreen();
            }
            else
            {
