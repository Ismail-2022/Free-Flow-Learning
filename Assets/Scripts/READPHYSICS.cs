...
public class READPHYSICS : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string sqlQuery = "SELECT name,id, MAX(score) AS score FROM leader_board WHERE subject = 'Physics' GROUP BY name ORDER BY score DESC LIMIT 5";
